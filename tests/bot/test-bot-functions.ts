...
import { isWhitelisted } from '../../infra/cloudflare/worker/src/bot/auth'
import { parseCommand, parseCallbackData } from '../../infra/cloudflare/worker/src/bot/dispatcher'
import { t, detectLanguage } from '../../infra/cloudflare/worker/src/bot/i18n'
...
describe('Bot i18n Functions', () => {
  ...
  test('All i18n keys exist in both IT and EN', () => {
    const { messages } = require('../../infra/cloudflare/worker/src/bot/i18n')
